...
class LA32RDecode extends CoreModule {
  ...
  def slti       = BitPat("b0000001000 ??????? ????? ????? ?????") // SLTI rd, rj, si12
  def sltui      = BitPat("b0000001001 ??????? ????? ????? ?????") // SLTUI rd, rj, si12
  def addi_w     = BitPat("b0000001010 ??????? ????? ????? ?????") // ADDI.W rd, rj, si12
  def andi       = BitPat("b0000001101 ??????? ????? ????? ?????") // ANDI rd, rj, ui12
  def ori        = BitPat("b0000001110 ??????? ????? ????? ?????") // ORI rd, rj, ui12
  def xori       = BitPat("b0000001111 ??????? ????? ????? ?????") // XORI rd, rj, ui12
