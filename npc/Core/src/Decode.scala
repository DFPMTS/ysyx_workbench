...
fence      -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.NONE,          ImmType.X), // TODO
fence_i    -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.NONE,          ImmType.X), // TODO
sfence_vma -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.SFENCE_VMA,    ImmType.X),
ecall      -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.ECALL,         ImmType.X),
ebreak     -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.EBREAK,        ImmType.X),
...
mret       -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.MRET,          ImmType.X),
sret       -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.SRET,          ImmType.X),
wfi        -> List(N, N, SrcType.ZERO, SrcType.ZERO, FuType.FLAG, DecodeFlagOp.NONE,          ImmType.X), // TODO
...
lr_w       -> List(N, Y, SrcType.REG,  SrcType.ZERO, FuType.AMO,  AMOOp.LR_W,                 ImmType.X),// * RV32A begin
sc_w       -> List(N, Y, SrcType.REG,  SrcType.REG,  FuType.AMO,  AMOOp.SC_W,                 ImmType.X),
